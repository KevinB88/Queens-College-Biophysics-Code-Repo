...
def plot_multiple_general(container, key, save_png, filepath, show_plot, x_lbl, y_lbl, title):
    ...
    for i in range(len(container)):
        ...
        if i == 0:
            plt.plot(df[f'{x_lbl}'], df[f'{y_lbl}'], label=f'{key[i]}', linewidth=4)
        else:
            plt.plot(df[f'{x_lbl}'], df[f'{y_lbl}'], label=f'{key[i]}', linewidth=1)
