...
def tabulate_rho_density(container, filepath, time, delta_radius, w):
...
def tabulate_mass(container, filepath, time, delta_time, w):
...
def tabulate_densities(container, filepath, angle, time, delta_radius, w):
    final_state = container[len(container)-1]
