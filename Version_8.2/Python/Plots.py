...
def plt_rho_rad(container, radius, time, text, filepath, save_png, discrete, plot_show):
...
def plt_mass_base(mass_container, time, save_png, filepath, plot_show):
...
def plt_phi_rad_final(container, radius, angle, save_png, filepath, time, plot_show):
