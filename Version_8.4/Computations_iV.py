...
'''
        ...
        net_current_out += j_r_r(diffusive_layer, k, m, n, d_radius, 0) * m * d_radius * d_theta 
...
def solve(rings, rays, r, d, t, q, p, a, b, v, tube_placements, mass_loss_glb_mx, return_mass_tables, mean_first_passage_time, net_check):
    ...
    net_mass_loss_container = np.zeros([time_steps])
        ...
        for m in range(rings):
            ...
            if m == rings - 2:
                ...
                if k > 0 and mass_loss_glb_mx:
                    if mass_loss_tab[k-1] > mass_loss_tab[k]:
                        ...
                        if return_mass_tables:
                            return mass_loss_tab, mass_loss_tab_ii, glb_peak_time
                        else:
            ...
            for n in range(rays):
                ...
                if m == rings - 2:
                    ...
                    net_mass_loss_container[k] = net_current_out
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    if mean_first_passage_time:
        return m_f_p_t
    elif net_check:
        return net_mass_loss_container
    else:
        return diffusive_layer, central_phi_tab, mass_tab, mass_loss_tab, mass_loss_tab_ii, d_time, d_radius, advective_layer, info_dict, rho_mass_tab, phi_mass_tab
