...
def solve(rings, rays, r, d, t, q, p, a, b, v, tube_placements, mass_loss_glb_mx):
    ...
    for k in range(time_steps):
        ...
        for m in range(rings):
            ...
            for n in range(rays):
                ...
                if m == rings - 2:
                    net_current_out += j_r_r(diffusive_layer, k, m, n, d_radius, rings) * m * d_radius * d_theta

        m_f_p_t += net_current_out * k * d_time
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    return diffusive_layer, central_phi_tab, mass_tab, mass_loss_tab, mass_loss_tab_ii, d_time, d_radius, advective_layer, info_dict, rho_mass_tab, phi_mass_tab, m_f_p_t
