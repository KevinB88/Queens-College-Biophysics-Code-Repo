...
def u_density(phi, rho, k, m, n, d_radius, d_theta, d_time, central, rings, angle, a, b):
    ...
    return curr_density - component_a - component_b - component_c, component_b
...
def solve_ii(rings, rays, r, d, t, q, p, a, b, v, angle, comp_array, d_table_phi, d_table_rho, d_table_center):
        ...
        for m in range(rings):
            ...
            for n in range(rays):
                if m == rings - 1:
                    ...
                    # def u_density(phi, rho, k, m, n, d_radius, d_theta, d_time, central, rings, angle, a, b):
                    phi_tab[k + 1][m][n], save = u_density(phi_tab, rho_tab, k, m, n, d_radius, d_theta, d_time, phi_center, rings, angle, a, b)
                    comp_array[k] = save
                    if n == angle:
                        ...
                        if m == 0:
                            ...
                            d_table_phi[k] = phi_tab[k][m][n]
                            d_table_rho[k] = rho_tab[k][m]
                            d_table_center[k] = phi_center
